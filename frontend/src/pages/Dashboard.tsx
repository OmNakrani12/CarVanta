...
export const Dashboard: React.FC = () => {
  ...
  // 2. CLIENT SHOWROOM CATALOG (Logged in state - wrapped inside MainLayout sidebar)
  return (
    <MainLayout>
          ...
          <div className="flex items-center space-x-2 overflow-x-auto pb-1 md:pb-0 scrollbar-none pr-4 text-left">
            {categories.map((cat) => (
              <button
                ...
                className={`px-3.5 py-1.5 rounded-full text-[10px] font-bold uppercase tracking-wider transition-all border shrink-0 ${
            ...
            <div className="flex items-center space-x-2 overflow-x-auto pb-1.5 scrollbar-none pr-4">
              {brands.map((brand) => (
                <button
                  ...
                  className={`px-3 py-1 rounded text-[10px] font-extrabold uppercase tracking-wider transition-all border shrink-0 ${
                    selectedBrand === brand
